...
#
W1 = tf.cast(tf.Variable(tf.random_normal([784, 100])), tf.float16)
b1 = tf.cast(tf.Variable(tf.random_normal([100,])), tf.float16)
...
# weights and baises are declared.
#
W2 = tf.cast(tf.Variable(tf.random_normal([100,10])), tf.float16)
b2 = tf.cast(tf.Variable(tf.random_normal([10,])), tf.float16)
...
# weights and baises are declared.
#
W3 = tf.cast(tf.Variable(tf.random_normal([10,10])), tf.float16)
b3 = tf.cast(tf.Variable(tf.random_normal([10,])), tf.float16)
